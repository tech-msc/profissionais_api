...
public class SwaggerConfig {
	...
	private ApiInfo metaInfo() {
		ApiInfo apiInfo = new ApiInfo("API Profissionais",
				"Fornece dados para gerenciamento de profissionais e estabelecimentos", "1.0", "Terms of Service",
				new Contact("Matheus S. Cardoso", "https://www.linkedin.com/in/matheusscardoso/",
